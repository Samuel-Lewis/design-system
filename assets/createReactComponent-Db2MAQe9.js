import{R as p,r}from"./index-CTjT7uj6.js";import{a as h}from"./use-isomorphic-effect-DbnTQc-6.js";function g(){return`mantine-${Math.random().toString(36).slice(2,11)}`}const k=p.useId||(()=>{});function v(){const t=k();return t?`mantine-${t.replace(/:/g,"")}`:""}function R(t){const e=v(),[o,n]=r.useState(e);return h(()=>{n(g())},[]),typeof t=="string"?t:typeof window>"u"?e:o}/**
