import{R as g,r as a}from"./index-DRjF_FHU.js";import{a as v}from"./use-isomorphic-effect-CtQhMHy6.js";import{j as x}from"./jsx-runtime-DR9Q75dM.js";import{p as k,u as B,a as b,B as S}from"./polymorphic-factory-Br8q5MDG.js";function _(t="mantine-"){return`${t}${Math.random().toString(36).slice(2,11)}`}const E=g.useId||(()=>{});function I(){const t=E();return t?`mantine-${t.replace(/:/g,"")}`:""}function A(t){const e=I(),[o,s]=a.useState(e);return v(()=>{s(_())},[]),typeof t=="string"?t:typeof window>"u"?e:o}var p={root:"m_87cf2631"};const R={__staticSelector:"UnstyledButton"},f=k((t,e)=>{const o=B("UnstyledButton",R,t),{className:s,component:r="button",__staticSelector:u,unstyled:i,classNames:l,styles:c,style:m,...n}=o,d=b({name:u,props:o,classes:p,className:s,style:m,classNames:l,styles:c,unstyled:i});return x.jsx(S,{...d("root",{focusable:!0}),component:r,ref:e,type:r==="button"?"button":void 0,...n})});f.classes=p;f.displayName="@mantine/core/UnstyledButton";/**
